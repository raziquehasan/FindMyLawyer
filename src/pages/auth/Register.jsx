...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex flex-col items-center justify-start px-4 py-10">
      ...
      {/* ── FOOTER ── */}
      <footer className="w-full bg-gray-900 text-white py-8 px-4 mt-10">
