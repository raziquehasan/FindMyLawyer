...
export default function Login() {
    ...
    const interval = setInterval(() => {
      ...
      setTimeout(() => {
        setFactIndex((prev) => {
          ...
          return nextIndex >= rightsFacts.length ? 0 : nextIndex;
        });
        setVisible(true);
      }, 400);
    }, 4000);
  ...
  }, [rightsFacts.length]); // Add rightsFacts.length as dependency
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden font-sans">
        ...
        <div className="hidden md:flex md:w-1/2 bg-black text-white flex-col justify-between p-16 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-400 mt-4 text-lg">
              Talk to a Verified Lawyer Today
            </p>
          </div>
          ...
          <div className="relative z-10">
            ...
            <ul className="space-y-4 text-gray-300">
              <li className="flex items-center gap-3">
                ...
                <span>Connect with verified lawyers</span>
              </li>
              <li className="flex items-center gap-3">
        ...
        <div className="flex w-full md:w-1/2 bg-gray-100 items-start justify-center px-6 py-6 overflow-y-auto">
          <div className="w-full max-w-md my-auto">
            ...
            <div className="mb-4">
              ...
              <div
                className={`flex items-center border-2 rounded-lg px-4 py-2.5 bg-white transition-all ${
                  errors.email
      ...
      {/* KNOW YOUR RIGHTS FOOTER - responsive with safety check */}
      {rightsFacts.length > 0 && (
        <footer className="w-full bg-gray-900 text-white py-3 px-4 flex-shrink-0">
          <div className="max-w-2xl mx-auto flex flex-col items-center text-center">
            ...
            >
              "{rightsFacts[factIndex] || rightsFacts[0]}"
            </p>
